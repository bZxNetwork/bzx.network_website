...
Only vulnerabilities found in the smart contracts on-chain will be considered eligible for a bug bounty. Bugs in the web front-end will not be included in the scope of the program. We ask that any bugs found be disclosed privately to the team. Please do not execute a proof of concept of mainnet.
