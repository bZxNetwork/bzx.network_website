...
<section class="mt-40 bg-wave text-center">
    <div class="buttons-wrapper container container-md d-flex f-wrap j-content-sb px-65 px-xs-15">
        ...
        <a href="https://www.coingecko.com/en/coins/bzx-protocol" class="button button-primary button-lg d-flex j-content-center mb-10">BZRX&nbsp;<img class="p-absolute header-button-icon" width="15" height="15" src="images/icons/coingecko.png" alt="Coingecko Logo"/></a>
